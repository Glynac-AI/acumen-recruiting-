...
const AboutStory: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="py-28 relative overflow-hidden" id="story">
      {/* Background with parallax effect */}
      <motion.div
        className="absolute inset-0 bg-gradient-to-b from-white to-gray-50/50 transform-gpu will-change-transform"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              >
                ...
                <div className="mt-4 ml-20 text-sm text-ph font-medium tracking-wide">FOUNDER, ACUMEN RECRUITING</div>
              </motion.div>
            </motion.div>
                ...
                {[
                  {
                    title: "Excellence",
                    description:
                      "We're committed to excellence in every aspect of our work, from candidate selection to client communication.",
                  },
                  {
                    title: "Integrity",
                    description:
                      "We operate with complete transparency and honesty, creating trust with both clients and candidates.",
                  },
                  {
                    title: "Innovation",
                    description:
                      "We continuously refine our approach, integrating new technologies while enhancing the human element.",
                  },
                  {
                    title: "Partnership",
                    description:
                      "We view ourselves as partners in our clients' success, not just service providers.",
                  },
                ].map((value, index) => (
                  <motion.div
                    key={value.title}
                  ...
                  >
                    <div className="w-12 h-12 rounded-full bg-ph/10 flex items-center justify-center text-ph shrink-0 mt-1">
                      <div className="w-4 h-4 rounded-full bg-ph" />
                    </div>
                    <div>
