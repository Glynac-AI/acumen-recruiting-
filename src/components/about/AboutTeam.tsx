...
const AboutTeam = () => {
    ...
    const teamMembers = [
        {
            ...
            image: "/images/team/sarah-johnson.jpg", // You'll need to add these images
    ...
    // For demo purposes, generate initials if no image is available
                            ...
                            <div className="p-6 md:p-8 flex flex-col md:flex-row gap-6">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <motion.a
                                            href={`mailto:${member.name.toLowerCase().replace(' ', '.')}@acumenrecruiting.com`}
                                            className="w-8 h-8 rounded-full flex items-center justify-center border border-gray-200 text-muted-foreground hover:bg-ph hover:text-white hover:border-ph transition-colors"
                                            whileHover={{ y: -2 }}
                                            whileTap={{ scale: 0.95 }}
