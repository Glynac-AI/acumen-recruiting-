    ...
    const expertiseCategories = [
        {
            ...
            details: [
                "Wealth management career paths",
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5 max-w-5xl mx-auto mb-24">
                    {trackRecordStats.map((stat, index) => (
                        <motion.div
                            key={index}
                            className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 text-center hover:shadow-md transition-all duration-300 hover:-translate-y-1"
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="text-center p-4">
                            ...
                            <div className="text-3xl font-light text-foreground mb-1">93<span className="text-ph">%</span></div>
                        ...
                        <div className="text-center p-4 border-t md:border-t-0 border-gray-100">
                            ...
                            <div className="text-3xl font-light text-foreground mb-1">2,000<span className="text-ph">+</span></div>
