...
const ServicesHero = () => {
  ...
  // Wave animation pause on hover of highlighted word
        ...
        <motion.div className="container mx-auto px-4 text-center" style={{ opacity: contentOpacity }}>
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="max-w-4xl mx-auto">
            <h1 className="text-[clamp(3rem,8vw,6.5rem)] leading-[1.1] font-display tracking-[-0.03em] text-[#0A2540]">
              <span className="font-light block">Sophisticated recruiting</span>
              <motion.span
              ...
              <span className="font-light"> for wealth management</span>
            </h1>
            <motion.p
          ...
          >
            <motion.a href="/services#services" className="group relative overflow-hidden rounded-full bg-[#4F6BFF] px-8 py-4 text-white shadow-lg" whileHover={{ y: -4 }} transition={{ duration: 0.2 }}>
