        ...
        <motion.div className="container mx-auto px-4 text-center" style={{ opacity: contentOpacity }}>
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="max-w-4xl mx-auto">
            <h1 className="text-[clamp(3rem,8vw,6.5rem)] leading-[1.1] font-display tracking-[-0.03em] text-[#0A2540]">
              <span className="font-light block">Let’s transform your</span>
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#4F6BFF] to-[#4F6BFF]/80 font-normal inline-block">
                talent strategy
              </span>
            </h1>
            <motion.p className="mt-8 text-xl md:text-2xl text-[#505c6e] max-w-2xl mx-auto leading-relaxed" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.2 }}>
              Book a consultation—no pressure, just signal and clarity.
            </motion.p>
          </motion.div>
          ...
          <motion.div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.4 }}>
            <motion.a href="#contact-form" className="group relative overflow-hidden rounded-full bg-[#4F6BFF] px-8 py-4 text-white shadow-lg" whileHover={{ y: -4 }} transition={{ duration: 0.2 }}>
              <span className="relative z-10 text-base font-medium tracking-wide">Start a conversation</span>
            ...
            <motion.a href="/services" className="group relative rounded-full border border-[#E5E7EB] px-8 py-4 text-[#0A2540] hover:border-[#4F6BFF]/30 transition-colors" whileHover={{ y: -4 }} transition={{ duration: 0.2 }}>
              <span className="text-base font-medium tracking-wide">Explore services</span>
            </motion.a>
          </motion.div>
        </motion.div>
      </div>
